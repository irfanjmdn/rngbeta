    ...
    <div class="desktop-reminder-screen" id="desktopReminderScreen">
      <div class="reminder-modal-card">
        <div class="reminder-card-header">
          <span class="reminder-tag">SYSTEM CALIBRATION</span>
          <span class="reminder-subtag">ENV-CHECK // DESKTOP ONLY</span>
        </div>
        ...
        <div class="reminder-card-body">
          <div class="reminder-icon-box">
            <svg
              ...
              aria-hidden="true"
            >
              <rect x="2" y="3" width="20" height="14" rx="0" ry="0"></rect>
          ...
          <p class="reminder-desc">
            Track RNG uses precise carousel reel layouts, audio meters, and spatial stage effects built specifically for desktop displays.
          </p>

          <div class="reminder-specs-grid" aria-label="System Requirements">
            <div class="reminder-spec-chip">
              <span class="spec-label">DISPLAY</span>
              <span class="spec-value">MIN 1280 × 800</span>
            </div>
            <div class="reminder-spec-chip">
              <span class="spec-label">INPUT</span>
              <span class="spec-value">KEYBOARD & MOUSE</span>
            </div>
            <div class="reminder-spec-chip">
              <span class="spec-label">AUDIO</span>
              <span class="spec-value">STEREO PREVIEW</span>
            </div>
          </div>
        </div>
        ...
        <div class="reminder-card-footer">
          ...
          >
            ...
            <span class="reminder-btn-kbd">↵ Enter</span>
          </button>
        </div>
      </div>
    </div>
